            ...
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <p class="text-muted">Review and delete inappropriate listings</p>
                    </div>
            ...
            <div class="col-12">
                                    ...
                                    <div class="card-body d-flex flex-column h-100">
                                        <div>
                                            ...
                                            <p class="text-muted small mb-2">
                                                <strong>Category:</strong> {{ $listing->category->name ?? 'N/A' }}
                                            </p>
                                            ...
                                            <p class="text-muted small mb-0">
                                                <strong>Posted:</strong> {{ $listing->created_at->format('M d, Y H:i') }}
                                            </p>
                                        </div>
                                        ...
                                        <div class="mt-3 pt-3 border-top">
                                            <div class="btn-group w-100" role="group">
                                                ...
                                                <form action="{{ route('admin.deleteListing', $listing) }}" method="POST" class="flex-grow-1">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button
                                                        type="submit"
                ...
                <div class="card text-center py-5">
                    <div class="card-body">
                        ...
                        <p class="text-muted mb-0">No listings to review</p>
                    </div>
                </div>
                @endif
            </div>
