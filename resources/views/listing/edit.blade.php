            ...
            <div class="col-lg-8">
                <div class="mb-4">
                    <a href="{{ route('listing.show', $listing) }}" class="btn btn-outline-secondary">
                        <i class="bi bi-arrow-left"></i> {{ __('messages.listings.back_to_listing') }}
                    </a>
                </div>
                ...
                <div class="card shadow-sm">
                    <div class="card-body p-5">
                        <h1 class="card-title mb-4">
                            <i class="bi bi-pencil-square"></i> {{ __('messages.listings.edit_title') }}
                        </h1>
                        ...
                        <form action="{{ route('listing.update', $listing) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-4">
                                <label class="form-label"><strong>{{ __('messages.listings.current_images') }}</strong></label>
                                <div class="row">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        <div class="card">
                                            <img
                                                ...
                                                alt="{{ __('messages.listings.preview_alt') }}"
                                                class="card-img-top"
                                                style="height: 150px; object-fit: cover;">
                                            <div class="card-body p-2">
                                                <small class="text-muted">
                                                    {{ __('messages.listings.uploaded_date', ['date' => $image->created_at->format('M d')]) }}
                                                </small>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="mb-4">
                                <label for="images" class="form-label"><strong>{{ __('messages.listings.add_new_images') }}</strong></label>
                            ...
                            <div class="d-grid gap-2">
                                <button type="submit" class="btn btn-primary btn-lg">
                                    <i class="bi bi-check-circle"></i> {{ __('messages.listings.save_changes_btn') }}
                                </button>
                                <a href="{{ route('listing.show', $listing) }}" class="btn btn-outline-secondary">
